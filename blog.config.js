...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '田小野', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '师者，传道授业解惑也', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'math, 数学,田老师', // 网站关键词 英文逗号隔开
